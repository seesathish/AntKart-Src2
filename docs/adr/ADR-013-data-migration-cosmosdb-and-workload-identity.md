# ADR-013 — Products Persistence: Cosmos DB Migration and Workload Identity Foundation

**Status:** Accepted  
**Date:** 2026-05-31  
**Week:** 5 — Second Application Code Change  
**Relates to:** ADR-011 (Cosmos DB and Service Bus infrastructure provisioning), ADR-012 (Service Bus token auth)
