# ADR-012 — Messaging Migration: RabbitMQ → Azure Service Bus with Token Authentication

**Status:** Accepted  
**Date:** 2026-05-31  
**Week:** 4 — First Application Code Change  
**Relates to:** ADR-011 (Cosmos DB and Service Bus infrastructure provisioning)
