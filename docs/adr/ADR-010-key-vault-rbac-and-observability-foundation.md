# ADR-010 — Key Vault RBAC Authorization, Workspace-Based App Insights, and ACR Basic-to-Premium Strategy
...
- ADR-009 — Infrastructure as Code with Terraform and Terragrunt
